...
// Original by Jensen and from v1.3+, moded by Elia
...
var $Splitter = new function(){
    ...
    this.Init = function(){
        ...
        FbWnd = (utils.CreateWND(window.ID)).GetAncestor(2);
    }
    
    //=======================================

    /* IsAreoEnabled, CreateGlass, ReleaseCapture 及 SendAMessage 都不再推荐使
       用，建议直接使用 WSHMP 自带的接口 */
    
    this.IsAeroEnabled = function() {
        return utils.IsAeroEnabled();
    }
    
    this.CreateGlass = function (l, r, t, b) {
        FbWnd&&FbWnd.CreateGlass(l, r, t, b);
    }
    ...
    Panel.prototype.Refresh = function(){
        ...
        if(this.visible)
            ...
            this.Wnd.Show(0);
        //et.SendMessageEx(this.Wnd, 0x0F, 0, 0);
    }
    ...
    /*// Other functions
    Panel.prototype.ShowScrollbar = function(target, show){
        et.ShowScrollBarEx(this.Wnd, target, show);
    }
    
    Panel.prototype.IsShowScrollbar = function(target){
        return et.IsScrollbarVisible(this.Wnd, target);
    }
    
    this.IsPanelVisible = function (FbWnd){
        return GetWindowInfoEx(FbWnd, );
    }
    
    this.GetPanelPos = function (FbWnd, pos){
        return GetWindowInfoEx(FbWnd, );
    }
    */
    //=======================================
